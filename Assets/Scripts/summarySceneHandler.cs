...
public class summarySceneHandler : MonoBehaviour
{
    ...
    public void mechanismClicked(Button button)
    {
        ...
        int n = Array.IndexOf(JediSerialPayload.MECHANISMS, title);
        title = JediSerialPayload.MECHANISMSTEXT[n];
    ...
    public void initializeChart()
    {
        ...
        sessionDataHandler = new SessionDataHandler(Path.Combine(AppData.idPath,"Sessions.csv"));
